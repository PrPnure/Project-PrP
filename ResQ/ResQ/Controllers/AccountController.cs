...
namespace ResQ.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, UserLastName = model.LastName, UserFirstName=model.FirstName };
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        _cont.Informations.Add(new HelpInfo() { Email = model.Email, Password = model.Password });
                        _cont.SaveChanges();
                    }
