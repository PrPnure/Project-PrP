...
namespace ResQ.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [EmailAddress] // что-то вроде фильтра. происходит проверка на валидность e_mail
        [Display(Name = "Email")]
        public string Email { get; set; }

        [Required(ErrorMessage = "Поле пароль должно быть заполнено")]
        [StringLength(100, ErrorMessage = "Пароль должен быть длинной не меньше {2} символов", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Пароль")]
        public string Password { get; set; }
